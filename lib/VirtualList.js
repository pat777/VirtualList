...
Ext.ux.VirtualList = Ext.extend(Ext.List, {
	...
	// This value * 3 is the effectively item count
	...
	initComponent: function() {
		...
		this.itemTplDelayed = new Ext.XTemplate('<div class="x-list-item"><div class="x-list-item-body">' +
				this.itemTpl + '</div></div>').compile();
